        ...
        try {
            ...
            const sceneEntities = (plan.scenes || []).map((scene) =>
                this.videoSceneRepository.create({
                    ...
                    visual: scene.visual ? (scene.visual as unknown as Record<string, unknown>) : undefined,
                    transition: scene.transition ? (scene.transition as unknown as Record<string, unknown>) : undefined,
