import { c as useRuntimeConfig, s as useNuxtApp } from "./head-DEDv5v4O.js";
import { D as __exportAll, E as navigateTo, O as __reExport, S as useForwardExpose, T as $fetch, _ as useForwardProps, a as formFieldInjectionKey, b as looseToNumber, c as formOptionsInjectionKey, d as useFormField, f as useFieldGroup, g as tv, h as _sfc_main$6, i as formErrorsInjectionKey, l as formStateInjectionKey, m as _sfc_main$7, n as _sfc_main$8, o as formInputsInjectionKey, p as useComponentIcons, r as formBusInjectionKey, s as formLoadingInjectionKey, u as inputIdInjectionKey, v as useComponentProps, w as useAppConfig, x as Primitive, y as useLocale } from "../server.mjs";
import { Fragment, computed, createBlock, createCommentVNode, createTextVNode, createVNode, defineComponent, guardReactiveProps, inject, mergeProps, normalizeProps, onScopeDispose, openBlock, provide, reactive, readonly, ref, renderList, renderSlot, resolveDynamicComponent, toDisplayString, toRaw, unref, useId, useSSRContext, useSlots, useTemplateRef, watch, withCtx } from "vue";
...
import { createReusableTemplate, reactivePick, useEventBus, useVModel } from "@vueuse/core";
...
var _sfc_setup$8 = _sfc_main$5.setup;
...
var _sfc_setup$7 = _sfc_main$4.setup;
					...
					if (_push) {
						...
						if (unref(isLeading) || !!unref(props).avatar || !!slots.leading) {
							...
							ssrRenderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => {
								...
								else if (!!unref(props).avatar) _push(ssrRenderComponent(_sfc_main$7, mergeProps({ size: unref(props).ui?.leadingAvatarSize || ui.value.leadingAvatarSize() }, unref(props).avatar, {
						...
						unref(isLeading) || !!unref(props).avatar || !!slots.leading ? (openBlock(), createBlock("span", {
							...
							"data-slot": "leadingIcon",
							class: ui.value.leadingIcon({ class: unref(props).ui?.leadingIcon })
						}, null, 8, ["name", "class"])) : !!unref(props).avatar ? (openBlock(), createBlock(_sfc_main$7, mergeProps({
							key: 1,
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(unref(Primitive), mergeProps({
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						ssrRenderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => {
							if (unref(props).avatar) _push(ssrRenderComponent(_sfc_main$7, mergeProps({ size: unref(props).ui?.avatarSize || ui.value.avatarSize() }, unref(props).avatar, {
								"data-slot": "avatar",
						...
						renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [unref(props).avatar ? (openBlock(), createBlock(_sfc_main$7, mergeProps({
							key: 0,
						...
						}), 128))], void 0, 0) : createCommentVNode("", true), renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => [unref(props).close ? (openBlock(), createBlock(_sfc_main$8, mergeProps({
							key: 0,
							icon: unref(props).closeIcon || unref(appConfig).ui.icons.close,
							color: "neutral",
							variant: "link",
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						ssrRenderSlot(_ctx.$slots, "default", { ui: ui.value }, () => {
							...
							else if (unref(props).avatar) _push(ssrRenderComponent(_sfc_main$7, mergeProps({ size: unref(props).ui?.avatarSize || ui.value.avatarSize() }, unref(props).avatar, {
								"data-slot": "avatar",
								class: ui.value.avatar({ class: unref(props).ui?.avatar })
							}), null, _parent, _scopeId));
							else _push(`<!---->`);
						...
						"data-slot": "label",
						class: ui.value.label({ class: unref(props).ui?.label })
					}, toDisplayString(unref(props).label), 3)) : unref(props).icon ? (openBlock(), createBlock(_sfc_main$6, {
						key: 1,
						name: unref(props).icon,
						"data-slot": "icon",
						class: ui.value.icon({ class: unref(props).ui?.icon })
...
//#endregion
//#region node_modules/@pinia/nuxt/dist/runtime/composables.js
...
var useAuthStore = (0, composables_exports.defineStore)("auth", () => {
...
//#endregion
//#region app/components/social/google-login.vue?vue&type=script&setup=true&lang.ts
var google_login_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "google-login",
	__ssrInlineRender: true,
	setup(__props) {
		const auth = useAuthStore();
		async function ggLoginSuccess(response) {
			const { credential } = response;
			if (credential) await auth.signInWithToken(credential);
		}
		function ggLoginError() {
			console.error("Google login failed");
		}
		return (_ctx, _push, _parent, _attrs) => {
			_push(ssrRenderComponent(unref(GoogleSignInButton), mergeProps({
				onSuccess: ggLoginSuccess,
				onError: ggLoginError,
				size: "large",
				width: "240",
				text: "continue_with"
			}, _attrs), null, _parent));
...
//#endregion
//#region app/components/social/google-login.vue
var _sfc_setup$2 = google_login_vue_vue_type_script_setup_true_lang_default.setup;
google_login_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/social/google-login.vue");
	return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
var google_login_default = Object.assign(google_login_vue_vue_type_script_setup_true_lang_default, { __name: "SocialGoogleLogin" });
//#endregion
//#region app/components/social/facebook-login.vue?vue&type=script&setup=true&lang.ts
var facebook_login_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "facebook-login",
	__ssrInlineRender: true,
	setup(__props) {
		const HFaceBookLogin = FacebookLoginPkg.HFaceBookLogin || FacebookLoginPkg;
		const auth = useAuthStore();
		async function fbLoginSuccess(response) {
			const accessToken = response?.authResponse?.accessToken;
			if (accessToken) await auth.signInWithToken(accessToken);
		}
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(HFaceBookLogin), mergeProps({
				"app-id": "1966803287385992",
				onOnSuccess: fbLoginSuccess,
				onOnFailure: fbLoginError,
				scope: "email,public_profile",
				fields: "id,name,email,name,picture"
			}, _attrs), {
				default: withCtx((fbLogin, _push, _parent, _scopeId) => {
...
//#endregion
//#region app/components/social/facebook-login.vue
var _sfc_setup$1 = facebook_login_vue_vue_type_script_setup_true_lang_default.setup;
facebook_login_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/social/facebook-login.vue");
	return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
var facebook_login_default = Object.assign(facebook_login_vue_vue_type_script_setup_true_lang_default, { __name: "SocialFacebookLogin" });
//#endregion
...
var index_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			const _component_social_google_login = google_login_default;
			const _component_social_facebook_login = facebook_login_default;
			const _component_UAvatar = _sfc_main$7;
			_push(`<div${ssrRenderAttrs(mergeProps({ class: "flex min-h-dvh items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4 dark:from-gray-950 dark:to-slate-900" }, _attrs))}>`);
			_push(ssrRenderComponent(_component_UCard, {
				class: "w-full max-w-md",
				variant: "outline"
			}, {
				header: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<div class="space-y-1 text-center"${_scopeId}><h1 class="text-2xl font-bold tracking-tight"${_scopeId}>Reellora</h1><p class="text-sm text-gray-500 dark:text-gray-400"${_scopeId}> Sign in to manage your social accounts </p></div>`);
					else return [createVNode("div", { class: "space-y-1 text-center" }, [createVNode("h1", { class: "text-2xl font-bold tracking-tight" }, "Reellora"), createVNode("p", { class: "text-sm text-gray-500 dark:text-gray-400" }, " Sign in to manage your social accounts ")])];
				}),
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (unref(auth).error) _push(ssrRenderComponent(_component_UAlert, {
							color: "error",
							variant: "soft",
							title: unref(auth).error,
							icon: "i-lucide-circle-alert",
							class: "mt-4"
						}, null, _parent, _scopeId));
						else _push(`<!---->`);
						if (unref(auth).isLoggedIn) _push(ssrRenderComponent(_component_UAlert, {
							color: "success",
							variant: "soft",
						...
						_push(`<div class="relative my-4"${_scopeId}>`);
						_push(ssrRenderComponent(_component_USeparator, { label: "or continue with" }, null, _parent, _scopeId));
						_push(`</div><div class="grid grid-cols-2 gap-3"${_scopeId}>`);
						_push(ssrRenderComponent(_component_social_google_login, null, null, _parent, _scopeId));
						_push(ssrRenderComponent(_component_social_facebook_login, null, null, _parent, _scopeId));
						_push(`</div>`);
						_push(ssrRenderComponent(_component_UButton, {
							color: "error",
							variant: "soft",
							...
							block: "",
							class: "mt-2",
							onClick: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))("/youtube/callback")
						}, null, _parent, _scopeId));
						_push(`</div>`);
						...
						unref(auth).error ? (openBlock(), createBlock(_component_UAlert, {
							key: 0,
							color: "error",
							variant: "soft",
							title: unref(auth).error,
						...
						unref(auth).isLoggedIn ? (openBlock(), createBlock(_component_UAlert, {
							key: 1,
							color: "success",
							variant: "soft",
							title: "Connected to the API successfully.",
						...
						createVNode("div", { class: "relative my-4" }, [createVNode(_component_USeparator, { label: "or continue with" })]),
						createVNode("div", { class: "grid grid-cols-2 gap-3" }, [createVNode(_component_social_google_login), createVNode(_component_social_facebook_login)]),
						createVNode(_component_UButton, {
							color: "error",
							variant: "soft",
							label: "Link YouTube",
			...
			if (unref(auth).isLoggedIn) {
				_push(`<div class="fixed inset-x-0 top-6 mx-auto w-full max-w-md">`);
				_push(ssrRenderComponent(_component_UCard, {
					class: "shadow-lg",
					variant: "soft",
					color: "success"
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) {
							...
							_push(`<div${_scopeId}><p class="font-semibold"${_scopeId}>${ssrInterpolate(unref(auth).user?.email)}</p><p class="text-xs text-gray-500"${_scopeId}>Role: ${ssrInterpolate(unref(auth).user?.role)}</p></div>`);
							_push(ssrRenderComponent(_component_UButton, {
								size: "sm",
								color: "neutral",
								variant: "ghost",
								label: "Sign out",
								class: "ms-auto",
								onClick: ($event) => unref(auth).signOut()
							}, null, _parent, _scopeId));
							_push(`</div>`);
							...
							createVNode("div", null, [createVNode("p", { class: "font-semibold" }, toDisplayString(unref(auth).user?.email), 1), createVNode("p", { class: "text-xs text-gray-500" }, "Role: " + toDisplayString(unref(auth).user?.role), 1)]),
							createVNode(_component_UButton, {
								size: "sm",
								color: "neutral",
								variant: "ghost",
...
//# sourceMappingURL=pages-Bu_XdyoY.js.map