...
import { defu, defuFn } from "C:/Users/DELL/Documents/Reellora-be/node_modules/defu/dist/defu.mjs";
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [{
	...
	name: "index",
	path: "/",
	component: () => import("./_nuxt/pages-2A2LhHAY.js")
}];
//#endregion
...
var lazyGlobalComponents = [["Icon", defineAsyncComponent(() => import("./_nuxt/components-CKlblM5R.js").then((n) => n.n).then((r) => r["default"] || r.default || r))]];
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BwXGcp1M.js"));
		const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Crnj7LQc.js"));
...
//#endregion
export { useAppConfig as a, entry_default as default, useAsyncData as i, NuxtLink as n, $fetch$2 as o, useFetch as r, _plugin_vue_export_helper_default as t };
