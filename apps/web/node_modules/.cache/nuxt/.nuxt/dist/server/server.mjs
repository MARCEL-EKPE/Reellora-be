import { a as defineNuxtPlugin, c as useRuntimeConfig, d as nuxtLinkDefaults, h as prodReporters, i as defineAppConfig, l as asyncDataDefaults, m as docsBase, n as applyPlugins, o as definePayloadPlugin, p as appDiagnostics, r as createNuxtApp, s as useNuxtApp, t as useHead$1, u as fetchDefaults } from "./_nuxt/head-DEDv5v4O.js";
import { defineProdDiagnostics } from "nostics";
import { Comment, Fragment, Suspense, Teleport, camelize, cloneVNode, computed, createApp, createBlock, createCommentVNode, createElementBlock, createTextVNode, createVNode, defineAsyncComponent, defineComponent, getCurrentInstance, getCurrentScope, guardReactiveProps, h, hasInjectionContext, inject, isReactive, isReadonly, isRef, isShallow, isVNode, markRaw, mergeModels, mergeProps, nextTick, normalizeProps, normalizeStyle, onErrorCaptured, onScopeDispose, onServerPrefetch, openBlock, provide, queuePostFlushCb, reactive, ref, renderList, renderSlot, resolveComponent, resolveDynamicComponent, shallowReactive, shallowRef, toDisplayString, toHandlerKey, toRaw, toRef, toRefs, toValue, unref, useId, useModel, useSSRContext, useSlots, useTemplateRef, watch, watchEffect, withCtx, withModifiers } from "vue";
import { executeAsync } from "C:/Users/DELL/Documents/Reellora-be/node_modules/nuxt/node_modules/unctx/dist/index.mjs";
import { createError, sanitizeStatusCode } from "C:/Users/DELL/Documents/Reellora-be/node_modules/nuxt/node_modules/@nuxt/nitro-server/dist/h3.mjs";
import { decodePath, encodePath, hasProtocol, isScriptProtocol, joinURL, parseQuery, parseURL, withQuery, withTrailingSlash, withoutTrailingSlash } from "C:/Users/DELL/Documents/Reellora-be/node_modules/ufo/dist/index.mjs";
import { $fetch } from "C:/Users/DELL/Documents/Reellora-be/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import defu, { defu as defu$1, defuFn } from "C:/Users/DELL/Documents/Reellora-be/node_modules/defu/dist/defu.mjs";
...
import { klona } from "C:/Users/DELL/Documents/Reellora-be/node_modules/klona/dist/index.mjs";
import { fnv1a64Base36 } from "C:/Users/DELL/Documents/Reellora-be/node_modules/fnv1a-64/dist/index.mjs";
import { identify } from "C:/Users/DELL/Documents/Reellora-be/node_modules/object-identity/index.js";
import "C:/Users/DELL/Documents/Reellora-be/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import { hash } from "C:/Users/DELL/Documents/Reellora-be/node_modules/ohash/dist/index.mjs";
import { Icon, _api, addAPIProvider, addIcon, getIcon, loadIcon, setCustomIconsLoader } from "@iconify/vue";
import colors from "tailwindcss/colors";
import { ssrInterpolate, ssrRenderClass, ssrRenderComponent, ssrRenderList, ssrRenderSlot, ssrRenderStyle, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
import { createSharedComposable, defaultWindow, onKeyStroke, reactiveOmit, reactivePick, unrefElement, useDebounceFn, useMounted, useRafFn, useVModel } from "@vueuse/core";
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [{
	...
	component: () => import("./_nuxt/callback-CBKEDeDI.js")
}, {
	name: "index",
	path: "/",
	component: () => import("./_nuxt/pages-CITyGcxz.js")
}];
//#endregion
...
//#endregion
//#region ../../node_modules/nuxt-vue3-google-signin/dist/runtime/plugin.js
			...
			ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(props).chip ? _sfc_main$12 : unref(Primitive)), mergeProps({ as: as.value.root }, unref(props).chip ? typeof unref(props).chip === "object" ? {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(props).src && !error.value) ssrRenderVNode(_push, createVNode(resolveDynamicComponent(as.value.img || unref("img")), mergeProps({
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) ssrRenderSlot(_ctx.$slots, "default", {}, () => {
									if (unref(props).icon) _push(ssrRenderComponent(_sfc_main$13, {
								...
								else return [renderSlot(_ctx.$slots, "default", {}, () => [unref(props).icon ? (openBlock(), createBlock(_sfc_main$13, {
									key: 0,
									name: unref(props).icon,
									"data-slot": "icon",
									class: ui.value.icon({ class: unref(props).ui?.icon })
						...
						default: withCtx(() => [renderSlot(_ctx.$slots, "default", {}, () => [unref(props).icon ? (openBlock(), createBlock(_sfc_main$13, {
							key: 0,
							name: unref(props).icon,
							"data-slot": "icon",
							class: ui.value.icon({ class: unref(props).ui?.icon })
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) {
								ssrRenderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => {
									if (unref(isLeading) && unref(leadingIconName)) _push(ssrRenderComponent(_sfc_main$13, {
								...
								ssrRenderSlot(_ctx.$slots, "trailing", { ui: ui.value }, () => {
									if (unref(isTrailing) && unref(trailingIconName)) _push(ssrRenderComponent(_sfc_main$13, {
								...
								renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(_sfc_main$13, {
									key: 0,
									name: unref(leadingIconName),
									"data-slot": "leadingIcon",
									class: ui.value.leadingIcon({
								...
								renderSlot(_ctx.$slots, "trailing", { ui: ui.value }, () => [unref(isTrailing) && unref(trailingIconName) ? (openBlock(), createBlock(_sfc_main$13, {
									key: 0,
									name: unref(trailingIconName),
									"data-slot": "trailingIcon",
									class: ui.value.trailingIcon({
				...
				default: withCtx(({ remaining, duration: totalDuration, open }, _push, _parent, _scopeId) => {
					if (_push) {
						ssrRenderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => {
							...
							else if (unref(props).icon) _push(ssrRenderComponent(_sfc_main$13, {
								name: unref(props).icon,
								"data-slot": "icon",
								class: ui.value.icon({ class: unref(props).ui?.icon })
							}, null, _parent, _scopeId));
						...
						renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [unref(props).avatar ? (openBlock(), createBlock(_sfc_main$11, mergeProps({
							...
							"data-slot": "avatar",
							class: ui.value.avatar({ class: unref(props).ui?.avatar })
						}), null, 16, ["size", "class"])) : unref(props).icon ? (openBlock(), createBlock(_sfc_main$13, {
							key: 1,
							name: unref(props).icon,
							"data-slot": "icon",
							class: ui.value.icon({ class: unref(props).ui?.icon })
...
var _sfc_main$1 = {
	...
	setup(__props) {
		...
		const stack = void 0;
		const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Dgc792UP.js"));
		const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-I99lYJ66.js"));
...
//#endregion
export { NuxtLink as C, __reExport as D, __exportAll as E, useForwardExpose as S, $fetch$2 as T, useForwardProps as _, formFieldInjectionKey as a, looseToNumber as b, formOptionsInjectionKey as c, useFormField as d, entry_default as default, useFieldGroup as f, tv as g, _sfc_main$13 as h, formErrorsInjectionKey as i, formStateInjectionKey as l, _sfc_main$11 as m, _sfc_main$8 as n, formInputsInjectionKey as o, useComponentIcons as p, formBusInjectionKey as r, formLoadingInjectionKey as s, _plugin_vue_export_helper_default as t, inputIdInjectionKey as u, useComponentProps as v, useAppConfig as w, Primitive as x, useLocale as y };
