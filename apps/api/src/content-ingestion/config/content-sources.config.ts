  ...
  const defaultSources: ContentSourceDefinition[] = [
    {
      ...
      enabled: true,
      description:
        'Fast breaking African and business news wire coverage (via reutersbest.com aggregator).',
    },
    {
      id: 'bloomberg-africa',
      ...
      enabled: true,
      description:
        'Placeholder Bloomberg Africa RSS endpoint — replace with a verified working feed URL.',
    },
    {
      ...
      enabled: true,
      description:
        'Strong Nigerian corporate, policy, market, and economy reporting.',
    },
    {
      id: 'afdb-reports',
      ...
      enabled: true,
      description:
        'Development finance, infrastructure, and policy updates from AfDB.',
    },
    {
      id: 'imf-africa-data',
